...
const AGENTS = [
  ...
  },
  {
    ...
    model: "Model A + RAG",
    desc: "Maps the plain-English procedure to the correct CPT / HCPCS code and selects specific ICD-10 diagnoses using vector search over 74,044 codes.",
  ...
  },
  {
    ...
    name: "Denial Analyst",
    model: "Model B + RAG",
    desc: "Diagnoses the denial root cause via RAG over historical resolutions, corrects the coding, and retries — or generates an appeal letter if unfixable.",
          ...
          <div className="rounded-2xl border border-white/6 bg-white/2 px-8 py-6">
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-3">
              {[
                ...
                { label: "OpenRouter", note: "2 LLM models" },
                { label: "Qdrant Cloud", note: "vector RAG" },
